...
- [Grownetics](https://grownetics.co) - Grownetics is a platform to help the world learn how to grow every plant better. Connect sensors to your plants and track them in real time. `GPL-3` `PHP`
